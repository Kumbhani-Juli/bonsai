	...
	const MiddleSectionTitleList = [
		...
		},
		{
			...
			freelanceTopSectionData: {
				...
				freelanceInnerContent:
					"Create & e-sign contracts from vetted templates. Get peace of mind and get on with your work.",
				freelanceInnerImg: freelanceContractImg,
			},
			freelanceServiceSectionData: {
				mainTitle:
					"Make sure you’re being professional and protected with customizable work contracts.",
				innerServiceData: [
					{
					...
					},
					{
						...
						serviceContent:
							"Auto-remind your client for their signature and receive a notification when it is signed.",
					},
				],
			...
			relatedFeaturesData: [
				{
					...
					featureContent:
						"Get paid on time using smart invoicing with automatic reminders, read-receipts and a variety of payment options.",
				...
				},
				{
					...
					featureContent:
						"Win more new client projects with powerful proposal software, service package offerings and electronic approval.",
		...
		},
		{
			...
			freelanceTopSectionData: {
				...
				freelanceInnerTitle:
					"Manage your own digital workspace and client list.",
				freelanceInnerContent:
					"From prospect to project and contract to payment, you can now manage everything all in one place.",
				freelanceInnerImg: freelanceClientCRMImg,
			},
			freelanceServiceSectionData: {
				mainTitle:
					"Save hours running your business by using powerful tools to keep it all organized.",
				innerServiceData: [
					{
					...
					},
					{
						...
						serviceContent:
							"Invite other contractors to your projects to manage tasks and track time together.",
					},
				],
			...
			relatedFeaturesData: [
				...
				},
				{
					...
					featureContent:
						"Use simple task lists and create task templates on your projects to see what needs to be done. Set due dates and get email reminders.",
		...
		},
		{
			...
			freelanceServiceSectionData: {
				mainTitle:
					"A fully-featured time tracker that’s built specifically for online contract work and invoicing clients.",
				innerServiceData: [
					{
					...
					},
					{
						...
						serviceContent:
							"Use the Bonsai time tracker on the web, mobile apps, macOS app and Chrome Extension.",
					},
				],
		...
		},
		{
			...
			freelanceTopSectionData: {
				...
				freelanceInnerContent:
					"Join thousands of freelancers getting paid faster with invoice automation, partial payments and more.",
				freelanceInnerImg: freelanceInvoicesImg,
			},
			freelanceServiceSectionData: {
				mainTitle:
					"Start using smart invoices designed to save time and get you paid without chasing clients.",
				innerServiceData: [
					{
					...
					},
					{
						...
						serviceContent:
							"Choose from a variety of global payment options such as credit card, ACH and PayPal.",
					},
					{
						serviceTitle: "Pro Features",
						serviceImg: freelanceProFeaturesImg,
						serviceContent:
							"Maximize your potential with attachment-locking, partial payments and more.",
					},
				],
				outerServiceTitle1: "Automate It",
				outerServiceImg1: freelanceCreateInvImg,
				outerServiceContent1:
					"Use smart invoicing to automatically create your next invoice, remind your client for payment, accrue an overdue late fee and send you read-receipts. Plus, you can use any of our invoice templates.",
			...
			relatedFeaturesData: [
				{
					...
					featureContent:
						"Keep track of the hours you work every day, on every project and on every device. Add notes and the task completed with each new entry.",
		...
		},
		{
			...
			freelanceTopSectionData: {
				...
				freelanceInnerContent:
					"Prioritize the week for your ongoing projects and create reusable task templates for new ones.",
			...
			freelanceServiceSectionData: {
				...
				innerServiceData: [
					{
						...
						serviceContent:
							"Add new tasks in seconds or reuse task templates you’ve saved on projects.",
					},
					{
				...
				outerServiceContent1:
					"Whether you’re managing tasks for your business or specific projects, you can add new instantly. You can even set up custom templates for new projects.",
				outerServiceTitle2: "Tie It Together",
				outerServiceImg2: freelanceInvoiceTimeSheetImg,
				outerServiceContent2:
					"Track time on your tasks and the timesheet will show what was completed when billing your client. Continue billing hours for a project’s ongoing tasks easily.",
				outerServiceTitle3: "Assign To Collaborators",
				outerServiceImg3: freelanceAddCollaboratorsImg,
				outerServiceContent3:
					"Have multiple people on a particular project? Add a collaborator for free any time to manage tasks together without granting full access to the project.",
		...
		},
		{
			...
			freelanceServiceSectionData: {
				mainTitle:
					"Stay on top of your business with simple financial reporting and predictable tax payments.",
				innerServiceData: [
					{
		...
		},
		{
			...
			freelanceTopSectionData: {
				...
				freelanceInnerContent:
					"From client intake forms to project-ending surveys, you can now easily collect input from clients.",
				freelanceInnerImg: freelanceFormsImg,
			},
			freelanceServiceSectionData: {
				mainTitle:
					"A lightweight form builder that is integrated perfectly into your client workflow.",
				innerServiceData: [
					{
						serviceTitle: "Clients & Projects",
						serviceImg: freelanceClientsProjectsImg,
						serviceContent:
							"Send forms to specific clients, on specific projects, for specific use-cases with ease.",
					},
					{
						serviceTitle: "Flexible Fields",
						serviceImg: freelanceFlexibleFieldsImg,
						serviceContent:
							"With the customizable field types, you can create the perfect form to fit your needs.",
					},
					{
						serviceTitle: "Reusable Forms",
						serviceImg: freelanceReusableFormsImg,
						serviceContent:
							"Standardize your end-to-end client process by reusing the same forms for  new projects.",
					},
				],
				outerServiceTitle1: "Integrate Your Forms",
				outerServiceImg1: freelanceIntegrateFormGraphicsImg,
				outerServiceContent1:
					"Forms that smoothly work with your client list and projects. From lead capture to client feedback surveys, start sending questionnaires that fit your workflow.",
				outerServiceTitle2: "Customize Fields",
				outerServiceImg2: freelanceCustomizeFieldsGraphicsImg,
				outerServiceContent2:
					"With flexible field types, you can get multiple-choice responses or free-form answers to best capture your client input. Make the forms your own.",
				outerServiceTitle3: "Be More Effective",
				outerServiceImg3: freelanceEffectiveGraphicsImg,
				outerServiceContent3:
					"Continue iterating on your questionnaires for new projects and improve your client experience. Send out the same forms or create a new one instantly.",
