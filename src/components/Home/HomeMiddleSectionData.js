...
import "../../assets/css/homeMidleSectionData.css";
		...
		<>
			<div style={{ padding: "inherit" }}>
				<div className="col-md-6" style={{ marginLeft: "5rem" }}>
					...
					<div className="heading-small-22 text-weight-light mb-3">
						{data?.content}
					</div>
					{/* <Link
						to={{
					...
					>
						EXPLORE {data.title.toUpperCase()}{" "}
				...
				<div className="text-center">
					<img
						src={data?.image}
						className="img-fluid sectiondata-img"
						alt={data?.title}
					/>
				</div>
			</div>
